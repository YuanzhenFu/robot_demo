...
def main():
    ...
    with st.container():
        ...
        with cols[0]:
            st.checkbox("📤 Left Panel",
                        key="show_left_panel",
                        help="Toggle visibility of data input panel")
        with cols[2]:
            st.checkbox("📊 Right Panel",
                        key="show_right_panel",
                        help="Toggle visibility of path analysis panel")

    st.markdown("<h1 style='text-align: center; margin-bottom: 2rem;'>🤖 Robot Capability Event Flow Analysis System</h1>",
    ...
    col1, col2, col3 = st.columns([left_width, main_width, right_width])
